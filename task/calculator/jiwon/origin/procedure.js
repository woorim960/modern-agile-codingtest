...
function changeArray(string) {
  ...
  while (changeString.includes('*') || changeString.includes('/') || changeString.includes('+') || changeString.includes('-')) { 
    ...
    if (changeString.includes('*') || changeString.includes('/') || changeString.includes('+') || changeString.includes('-')) {
